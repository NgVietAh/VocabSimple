        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Thống kê test ngữ pháp riêng
              FutureBuilder<Map<String, dynamic>>(
                future: ProgressService.getGrammarTestStats(),
                builder: (context, grammarStatsSnapshot) {
                  final grammarTests = grammarStatsSnapshot.data?['total'] ?? 0;
                  final grammarAvgScore =
                      grammarStatsSnapshot.data?['average'] ?? 0.0;
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                '$grammarTests bài • Trung bình: ${grammarAvgScore.toStringAsFixed(1)}%',
                                style: GoogleFonts.inter(
                                  fontSize: 13,
                                  color: Colors.white.withOpacity(0.9),
                                ),
